...
--------------------------------------*/
	  ...
	  centerPadding: '0px',
	  slidesToShow: 3,
	  prevArrow: '<img class="prev" src="/assets/img/icon/prev.png" alt="prev" />',
	  nextArrow: '<img class="next" src="/assets/img/icon/next.png" alt="next" />',
	  responsive: [
	...
	$('.four-item-w').slick({
			slidesToShow: 4,
			prevArrow: '<img class="prev" src="/assets/img/icon/w-prev.png" alt="prev" />',
			nextArrow: '<img class="next" src="/assets/img/icon/w-next.png" alt="next" />',
			responsive: [
				{ breakpoint: 1169, settings: { slidesToShow: 3 } },
				{ breakpoint: 969, settings: { slidesToShow: 3 } },
				{ breakpoint: 767, settings: { slidesToShow: 2 } },
